...
<template>
  <div class="search">
    ...
    <Modal :closable="false" @on-cancel="handleClose" v-model="showModeler" :mask-closable='false' footer-hide fullscreen class="modeler">
      <div slot="header">
      ...
      <div style="position:relative;height: 100%;">
        <iframe id="frame" :src="modelerUrl" frameborder="0" width="100%" height="100%" scrolling="auto"></iframe>
